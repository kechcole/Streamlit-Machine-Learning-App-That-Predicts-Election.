...
def create_model(data):
    ...
    return model, scaler, x_unscaled
...
def fetch_clean_data():
    ...
    data.drop(columns=['population', 'state_abbr', 'state_fips', 'state_name', 'lifemode_5','region', 'geometry'], inplace=True)
...
def main():
    ...
    model, scaler, raw_features = create_model(data)
